...
TOKEN = '7370209234:AAGVHRwxdTs4QKycgdTtk1gjeoACeloOsJY'
FORWARD_CHANNEL_ID = -1002446579868
CHANNEL_ID = -1002446579868
error_channel_id = -1002446579868
...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    command = f"./nand {target_ip} {target_port} {duration} 60"
    try:
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/xyrohax/68", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*CONTACT @Apex_Cheats FOR HELP*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*DM @Apex_Cheats*", parse_mode='Markdown')
